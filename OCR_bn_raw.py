...
def extract_bangla_text_from_pdf(pdf_path, output_txt_path=None):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Always use the Poppler path to ensure it works in Flask
...
# Works for only Bangla language. Slow Processing…
# Good for the CQ pdf files.
# Annoying header and footer texts.
# Aligned issue with MCQ(splitted style) Pdfs. So, use another approach.
